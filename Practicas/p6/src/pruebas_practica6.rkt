...
#| Módulo de pruebas unitarias para la Práctica 6 |#
...
(define expr32
  ...
  {Y {fun {b} 
    {{fun {f} {b {fun {x} {{f f} x}}}}
     {fun {f} {b {fun {x} {{f f} x}}}}}}}
  {{mk-fact {fun {fact}
      {fun {n} {if {zero? n} 1 {* n {fact {dec n}}}}}}}}}
  {{Y mk-fact} 5}})

;; Pruebas para el ejercicio 6.1
...
(test (parse expr05)
    (withS
       (list (bindingS 'a (numS 2)) (bindingS 'b (numS 3)) (bindingS 'c (numS 4)))
       (opS + (list (idS 'a) (idS 'b) (idS 'c)))))
(test (parse expr06)
    (withS
       (list
        (bindingS 'a (opS + (list (numS 2) (numS 3))))
        (bindingS 'b (opS * (list (numS 7) (numS 4))))
        (bindingS 'c (opS max (list (numS 1) (numS 7) (numS 2)))))
       (opS
        sqrt
        (list (opS mmodulo (list (idS 'a) (idS 'b) (idS 'c)))))))
(test (parse expr07)
    (withS
       (list
        (bindingS 'a (numS 2))
        (bindingS 'b (numS 3))
        (bindingS 'c (opS + (list (numS 2) (numS 3))))
        (bindingS 'd (withS (list (bindingS 'e (numS 1))) (idS 'e))))
       (opS max (list (idS 'a) (idS 'b) (idS 'c) (idS 'd)))))
(test (parse expr08)
    (withS*
       (list
        (bindingS 'a (numS 2))
        (bindingS 'b (opS + (list (idS 'a) (idS 'a)))))
       (idS 'b)))
(test (parse expr09)
    (withS*
       (list
        (bindingS 'a (numS 2))
        (bindingS 'b (opS + (list (idS 'a) (idS 'a))))
        (bindingS 'c (opS * (list (idS 'a) (idS 'b)))))
       (withS*
        (list (bindingS 'd (idS 'c)) (bindingS 'e (idS 'd)))
...
(test (parse expr10)
    (withS*
       (list
        (bindingS 'a (idS 'x))
        (bindingS 'b (opS + (list (idS 'a) (idS 'a)))))
       (withS (list (bindingS 'x (idS 'b))) (idS 'x))))
...
(test (parse expr20)
    (withS*
       ...
       (withS
        (list (bindingS 'a (numS 5)) (bindingS 'b (numS 6)) (bindingS 'c (numS 7)))
        (appS (idS 'foo) (list (numS 10) (numS 20) (numS 30))))))
(test (parse expr21)
    (ifS (opS > (list (numS 10) (numS 2))) (boolS #t) (boolS #f)))
(test (parse expr22)
    (withS
       (list (bindingS 'a (numS 2)) (bindingS 'b (numS 4)) (bindingS 'c (numS 3)))
       (ifS
        (opS > (list (idS 'a) (numS 2)))
       ...
       (list
        ...
        (bindingS
         ...
         (funS
          '(x y z)
          (withS*
           (list (bindingS 'd (appS (idS 'disc) (list (idS 'x) (idS 'y) (idS 'z)))))
           (condS
            (list
...
(test (parse expr25)
    (withS
       (list
        (bindingS 'a (numS 3))
        (bindingS 'b (opS / (list (numS 10) (numS 0)))))
       (idS 'a)))
(test (parse expr26) (listS '()))
(test (parse expr27) (listS (list (numS 1) (numS 2) (numS 3) (numS 4) (numS 5))))
(test (parse expr28) (listS (list (boolS #t) (boolS #f) (boolS #t))))
(test (parse expr29)
    (recS
       (list
        (bindingS
         ...
         (funS
          ...
          (ifS
            ...
            *
            (list
             (idS 'n)
             (appS (idS 'fac) (list (opS sub1 (list (idS 'n))))))))))
        (bindingS 'x (numS 5)))
       (appS (idS 'fac) (list (idS 'x)))))
(test (parse expr30)
    (recS
       (list
        (bindingS
         ...
         (funS
          ...
          (ifS
           ...
           (opS
            ...
            (list
             (opS car (list (idS 'l)))
             (appS (idS 'suma) (list (opS cdr (list (idS 'l))))))))))
        (bindingS 'lista (listS (list (numS 1) (numS 2) (numS 3)))))
       (opS
        +
        (list
         (appS (idS 'longitud) (list (idS 'lista)))
         ...
         (funS
          ...
          (ifS
           ...
           (opS
            append
            (list
             (appS (idS 'reversa) (list (opS cdr (list (idS 'l)))))
             (listS (list (opS car (list (idS 'l))))))))))
        (bindingS
         'lista
         (listS (list (numS 1) (numS 2) (numS 3) (numS 4) (numS 5)))))
       (appS (idS 'reversa) (list (idS 'lista)))))

;; Pruebas para el ejercicio 6.2
...
(test (desugar (parse expr05))
    (app
 (fun 'a (fun 'b (fun 'c (op + (list (id 'a) (id 'b) (id 'c))))))
...
(test (desugar (parse expr07))
 ...
 (fun
  ...
  (fun
   ...
   (fun
    'c
    (fun 'd (op max (list (id 'a) (id 'b) (id 'c) (id 'd)))))))
 (list
  (num 2)
  (num 3)
  (op + (list (num 2) (num 3)))
      ...
      (app
       (fun
        ...
        (app
         (fun
          'a
          (fun 'b (fun 'c (app (id 'foo) (list (num 10) (num 20) (num 30))))))
...
(test (desugar (parse expr27)) (lisT (list (num 1) (num 2) (num 3) (num 4) (num 5))))
(test (desugar (parse expr28)) (lisT (list (bool #t) (bool #f) (bool #t))))
   ...
   (fun
    ...
    (iF
      ...
      *
      (list
       (id 'n)
       (app (id 'fac) (list (op sub1 (list (id 'n))))))))))
  (binding 'x (num 5)))
 (app (id 'fac) (list (id 'x)))))
   ...
   (fun
    ...
    (iF
     ...
     (op
      ...
      (list
       (num 1)
       (app (id 'longitud) (list (op cdr (list (id 'l))))))))))
  (binding
   'suma
   (fun
    'l
    (iF
     ...
     (op
      ...
      (list
       (op car (list (id 'l)))
       (app (id 'suma) (list (op cdr (list (id 'l))))))))))
  (binding 'lista (lisT (list (num 1) (num 2) (num 3)))))
 (op
  +
  (list
   (app (id 'longitud) (list (id 'lista)))
   (app (id 'suma) (list (id 'lista)))))))
(test (desugar (parse expr31))
    (rec
 (list
  (binding
   'reversa
   (fun
    ...
    (iF
     ...
     (op
      append
      (list
       (app (id 'reversa) (list (op cdr (list (id 'l)))))
       (lisT (list (op car (list (id 'l))))))))))
  (binding 'lista (lisT (list (num 1) (num 2) (num 3) (num 4) (num 5)))))
 (app (id 'reversa) (list (id 'lista)))))



;; Pruebas para el ejercicio 6.3
...
(test (interp (desugar (parse expr14)) (mtSub)) (closureV 'x (id 'x) (mtSub) (make-hash empty)))
...
(test (interp (desugar (parse expr22)) (mtSub)) (numV 4))
(test (interp (desugar (parse expr23)) (mtSub)) (boolV #f))
(test (interp (desugar (parse expr24)) (mtSub)) (numV 3))
(test (interp (desugar (parse expr25)) (mtSub)) (numV 3))
(test (interp (desugar (parse expr26)) (mtSub)) (listV '()))
(test (interp (desugar (parse expr27)) (mtSub)) (listV (list (numV 1) (numV 2) (numV 3) (numV 4) (numV 5))))
(test (interp (desugar (parse expr28)) (mtSub)) (listV (list (boolV #t) (boolV #f) (boolV #t))))
(test (interp (desugar (parse expr29)) (mtSub)) (numV 120))
(test (interp (desugar (parse expr30)) (mtSub)) (numV 9))
(test (interp (desugar (parse expr31)) (mtSub)) (listV (list (numV 5) (numV 4) (numV 3) (numV 2) (numV 1))))