...
;; Variable que guarda el total del ejercicio 4.1.
(define e41 0.0)
;; Variable que guarda el total del ejercicio 4.2.
(define e42 0.0)
;; Variable que guarda el total del ejercicio 4.3.
(define e43 0.0)
;; Variable que guarda el total del ejercicio 4.4.
(define e44 0.0)
...
(test (desugar (parse expr07))
    (app
     (fun 'a (fun 'b (fun 'c (fun 'd (op max (list (id 'a) (id 'b) (id 'c) (id 'd)))))))
     (list
      (num 2)
      (num 3)
      (op + (list (num 2) (num 3)))
         ...
         (fun
          ...
          (app
           (fun
            'foo
            (app
             (fun 'a (fun 'b (fun 'c (app (id 'foo) (list (num 10) (num 20) (num 30))))))
